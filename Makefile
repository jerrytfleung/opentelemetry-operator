...
DEFAULT_INSTRUMENTATION_PHP_VERSION ?= "1.4.0"
...
INSTRUMENTATION_PHP_VERSION ?= "1.4.0"
...
e2e-instrumentation-default: chainsaw
	$(CHAINSAW) test --test-dir ./tests/e2e-instrumentation/instrumentation-php --report-name e2e-instrumentation-php-default
...
e2e-instrumentation: chainsaw
	$(CHAINSAW) test --test-dir ./tests/e2e-instrumentation/instrumentation-php --report-name e2e-instrumentation-php
